...
echo.
echo   CLEARZPT SERVICE MANAGER v!LOCAL_VERSION!
...
set "hostsFile=%SystemRoot%\System32\drivers\etc\hosts"
set "hostsUrl=https://raw.githubusercontent.com/mrulme3/ClearZPT/refs/heads/main/hosts2"
